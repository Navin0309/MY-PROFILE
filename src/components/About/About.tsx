...
import VinayakSingh from "../../assets/main.png";
    ...
    <Container id="about">
      <div className="about-text">
        ...
        <ScrollAnimation animateIn="fadeInLeft" delay={0.1 * 1000}>
          <p>
          Hi there! I'm Navinkumar, a website developer with a passion for creating custom online experiences for my clients. With a skill set including HTML, CSS, JavaScript, React , Figma and photoshop I have the tools to bring any website vision to life.
          </p>
        </ScrollAnimation>
